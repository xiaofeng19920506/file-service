export default {
  ...
  bulletin: {
    ...
    create: '新建下周周报',
    driveSyncNotConfigured: 'Drive 同步未配置',
    driveSyncLastRun: 'Drive 最近同步：{time}',
    driveSyncError: 'Drive 同步错误：{error}',
    driveSyncNow: '立即同步 Drive',
    driveSyncing: '正在同步…',
    driveSyncDone: 'Drive 同步完成',
    created: '已创建周报',
    saved: '已保存',
    saving: '保存中…',
    save: '保存',
    ...
    verseOfWeekHint: '填写牧师邮箱并发送邀请；牧师提交后预览会自动更新。',
    verseOfWeekCurrent: '当前金句',
    verseAwaitingPastor: '尚未填写；周报编辑可邀请牧师添加本週金句。',
    versePastorInviteSectionIntro:
      '填写牧师邮箱。可点「立即发送」马上发邀请；未点发送时，系统仍会在每周一自动发送。',
    versePastorInviteSendNow: '立即发送邀请',
    versePastorInviteScheduleHint:
      '每周一上午也会自动发送（同一主日不会重复发）。清空邮箱则停止自动发送。',
    versePastorInviteLandingTitle: '本週金句',
    versePastorInviteLandingIntroSimple: '请为 {date} 主日周报填写本週金句（第 35 页）。',
    versePastorInviteLandingBodyLabel: '金句正文',
    versePastorInviteLandingSubmit: '提交金句',
    versePastorInviteLandingUpdate: '保存修改',
    versePastorInviteLandingSubmitting: '提交中…',
    versePastorInviteLandingSubmitted: '金句已提交，周报预览会自动更新。',
    versePastorInviteLandingSubmittedKeepEditing: '金句已保存。同一链接可随时回来修改。',
    versePastorInviteLandingCurrent: '当前已保存的金句',
    versePastorInviteLandingEmpty: '尚未提交金句。填写后可在下方预览投影效果。',
    versePastorInviteLandingPreview: '金句投影预览',
    ...
    editSlidesAppendUpload: '上传 PPT 追加到本区后',
    ...
    meetingVariant28: '版式 A',
    meetingVariant29: '版式 B',
    meetingVariant30: '版式 C',
    meetingVariantAdd: '添加模版',
    meetingVariantEdit: '修改模版',
    meetingVariantAdding: '上传中…',
    meetingVariantCustomHint: '自定义模版会替换本週聚会页；切回 A/B/C 可恢复模板版式。',
    announcements: '特别公告',
    ...
    sections: {
      ...
      offering: '奉献',
      birthday: '生日',
      announcements_group: '公告',
      announcement_item: '公告',
      baptism: '受洗',
      announcements: '公告',
    ...
    steps: {
      ...
      announcementsIntro: '在左侧「公告」⋯ 菜单添加一则；每则可显示/隐藏或移除。',
      announcement_item: '公告',
      baptism: '受洗',
      baptismTitle: '受洗 · 第 27 页',
      baptismIntro: '填写受洗日期或说明；本周无受洗可隐藏此分区。',
      verseTitle: '本週金句 · 第 35 页',
      verseIntro: '填写牧师邮箱并发送邀请，由牧师填写金句正文。',
    ...
    pastorInviteLandingReplace: '更换追加 PPT',
    pastorInviteLandingUploading: '上传中…',
    pastorInviteLandingSkip: '暂不上传，完成',
    pastorInviteLandingDone: '已完成',
    ...
    pastorInviteLandingUploadedAt: '上传时间：{time}',
    pastorInviteLandingRevisitHint: '请收藏本链接：可多次打开，查看并修改已提交内容（链接过期前有效）。',
    pastorInviteLandingPreview: '已上传内容预览',
    pastorInviteLandingPreviewSlide: '第 {n} 页',
    pastorInviteLandingPreviewUnavailable: '预览暂不可用',
    pastorInviteLandingInvalid: '邀请链接无效或已过期',
    pastorInviteLandingLoading: '加载邀请…',
    ...
    worshipImportYoutubeReconnect: '重新绑定 YouTube',
    ...
    worshipModeLabel: '敬拜播放格式',
    worshipModePpt: '仅 PPT',
    worshipModeYoutube: '仅 YouTube 歌单',
    worshipModePptYoutube: 'PPT + 歌单',
    worshipModePptHint: '投影只翻歌词 PPT，不播放 YouTube。',
    worshipModeYoutubeHint: '投影直接播放歌单视频。',
    worshipModePptYoutubeHint: '默认 PPT 前景、歌单背景播放；可切换到播歌单画面。',
    worshipModeUpdated: '已更新敬拜播放格式',
    worshipClipStart: '起点',
    worshipClipEnd: '终点',
    ...
    worshipClipAdd: '添加剪切',
    worshipClipView: '查看切片',
    worshipClipModalTitle: '剪切片段',
    worshipClipEmpty: '还没有剪切片段',
    worshipClipClear: '清除剪切',
    worshipSongTitle: '歌名',
    worshipSongComposer: '作曲',
    worshipSongAuthor: '作者',
    ...
    worshipClipLabel: '名称',
    worshipClipLabelPlaceholder: '输入名称',
    worshipClipEditLabel: '编辑名称',
    worshipClipUntitled: '片段 {n}',
    worshipClipFormatHint: '',
    worshipAddSongs: '添加歌曲',
    worshipAddSongsTabSearch: '搜索',
    worshipAddSongsTabYoutube: 'YouTube',
    worshipAddSongsTabYoutubePlaylists: '我的歌单',
    worshipModeCurrent: '当前：{mode}',
    worshipSlideNeedTracks: '请先添加歌曲',
  ...
  worshipSongs: {
    ...
    loading: '正在加载歌单…',
    inviteGuestHint:
      '你正在通过邀请链接编辑本周敬拜歌单，无需登录。请收藏本链接：可多次打开，增删改已添加的歌曲（链接过期前有效）。',
    addSection: '添加歌曲',
