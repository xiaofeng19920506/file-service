export default {
  ...
  bulletin: {
    ...
    pastorInviteTitle: '邀请牧师上传主日信息 PPT',
    pastorInviteHint:
      '将发送一封邮件，邀请对方为「主日信息」上传 PPT。对方也可以打开链接后选择暂不上传。',
    pastorInviteEmail: '牧师邮箱',
    pastorInviteEmailPlaceholder: 'pastor@example.com',
    pastorInviteMessage: '附言（可选）',
    pastorInviteMessagePlaceholder: '例如：本周日讲章大纲，欢迎用自己的 PPT。',
    pastorInviteSend: '发送邀请邮件',
    pastorInviteSending: '发送中…',
    pastorInviteSent: '邀请邮件已发送至 {email}',
    pastorInviteOpenSection: '邀请牧师上传 PPT',
    pastorInviteSectionIntro:
      '主日信息页来自模板。你可以邀请牧师上传自定义 PPT（可选）；发送邀请时会通过邮件通知对方。',
