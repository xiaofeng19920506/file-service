export default {
  ...
  admin: {
    ...
    downloadTitle: '下载 YouTube 音频 / 视频',
    downloadIntro: '粘贴 YouTube 链接或 11 位视频 ID。歌曲优先使用已缓存的 MP3；视频会临时拉取 MP4 后下载。',
    downloadUrlLabel: 'YouTube 链接或视频 ID',
    downloadUrlPlaceholder: 'https://www.youtube.com/watch?v=… 或 11 位 ID',
    downloadMp3: '下载歌曲',
    downloadMp4: '下载视频',
    downloadPreparing: '正在准备 MP3…',
    downloadPreparingVideo: '正在拉取视频，可能需要几分钟…',
    downloadReady: '已开始下载',
