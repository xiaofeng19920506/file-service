...
const en: MessageTree = {
  ...
  bulletin: {
    ...
    steps: {
      ...
      birthdayIntro:
        'Edit the month heading; add each name separately — the slide shows a grid and keeps each name on one line. Use Auto-arrange to sort Chinese then English names.',
    ...
    worshipClipStart: 'Play from',
    worshipClipEnd: 'Play until',
    worshipClipEndPlaceholder: 'Empty = to end',
    worshipClipStartPlaceholder: '0:00',
    worshipClipInvalid: 'Invalid time (use 1:20, 1:20:05, or seconds)',
    ...
    worshipClipLabel: 'Label',
    worshipClipLabelPlaceholder: 'Optional, e.g. chorus',
    worshipClipFormatHint: 'Format: m:ss (e.g. 1:20) or seconds; leave end empty for rest of track',
    worshipAddSongs: 'Add songs',
    worshipAddSongsTabSearch: 'Search / paste link',
    worshipAddSongsTabYoutube: 'Import YouTube playlist',
