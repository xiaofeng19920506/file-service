...
const en: MessageTree = {
  ...
  bulletin: {
    ...
    driveSyncNotConfigured: 'Drive sync not configured',
    driveSyncLastRun: 'Drive last sync: {time}',
    driveSyncError: 'Drive sync error: {error}',
    driveSyncNow: 'Sync Drive now',
    driveSyncing: 'Syncing…',
    driveSyncDone: 'Drive sync finished',
    ...
    verseOfWeekHint: 'Enter the pastor’s email and send an invite; preview updates after they submit.',
    verseOfWeekCurrent: 'Current verse',
    verseAwaitingPastor: 'Not filled yet. Bulletin editors can invite the pastor to add the verse.',
    versePastorInviteSectionIntro:
      'Enter the pastor’s email. Use “Send now” for an immediate invite; otherwise Mondays still send automatically.',
    versePastorInviteSendNow: 'Send invite now',
    versePastorInviteScheduleHint:
      'An automatic email also goes out Monday mornings (once per service date). Clear the email to stop.',
    versePastorInviteLandingTitle: 'Verse of the week',
    versePastorInviteLandingIntroSimple:
    ...
    meetingVariant28: 'Layout A',
    meetingVariant29: 'Layout B',
    meetingVariant30: 'Layout C',
    meetingVariantAdd: 'Add template',
    meetingVariantEdit: 'Edit template',
    meetingVariantAdding: 'Uploading…',
    meetingVariantCustomHint:
      'A custom template replaces the weekly-meeting slide. Switch back to A/B/C to use the built-in layouts.',
    ...
    sections: {
      ...
      offering: 'Offering',
      birthday: 'Birthdays',
      announcements_group: 'Announcements',
    ...
    steps: {
      ...
      announcementsIntro: 'Use ⋯ on Announcements to add an item. Show, hide, or remove each item from its menu.',
      announcement_item: 'Announcement',
      baptism: 'Baptism',
      baptismTitle: 'Baptism · slide 27',
      baptismIntro: 'Baptism date or note. Hide this section if there is no baptism this week.',
      verseTitle: 'Verse of the week · slide 35',
      verseIntro: 'Enter the pastor’s email and send an invite for them to fill in the verse text.',
    ...
    worshipClipExpandSegment: 'Expand segment',
    worshipClipCollapseSegment: 'Collapse segment',
    worshipClipAdd: 'Add clips',
    worshipClipView: 'View clips',
    worshipClipModalTitle: 'Clip segments',
    worshipClipEmpty: 'No clip segments yet',
    worshipClipClear: 'Clear clip',
    worshipSongTitle: 'Title',
    worshipSongComposer: 'Composer',
    worshipSongAuthor: 'Author',
    worshipSongYoutube: 'YouTube',
    ...
    worshipClipLabelPlaceholder: 'Enter a name',
    worshipClipEditLabel: 'Edit name',
    worshipClipUntitled: 'Clip {n}',
    ...
    doxologyYoutubeLabel: 'Doxology video',
    doxologyYoutubeHint:
      'Paste a YouTube URL or video ID. On the doxology slide, tap play: lyrics stay on screen while audio plays in the background (no maximized video).',
