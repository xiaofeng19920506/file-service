...
const en: MessageTree = {
  ...
  admin: {
    ...
    downloadIntro:
      'Paste a YouTube URL or 11-character video ID. Files are stored on the NAS under data/downloads (Videos for MP4, Music for MP3). Add that folder to Feiniu Movies / Music to play. Nothing is downloaded to this computer.',
