...
const en: MessageTree = {
  ...
  bulletin: {
    ...
    birthdayNamesHint: 'Add each person separately; the slide lays them out in a multi-column grid.',
    ...
    steps: {
      ...
      birthdayIntro: 'Edit the month heading; add each name separately — the slide shows them in a grid.',
