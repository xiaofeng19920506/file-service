...
const en: MessageTree = {
  ...
  bulletin: {
    ...
    steps: {
      ...
      announcementsTitle: 'Special thanks',
      announcementsIntro: 'Edit title and body for this slide. Hide the section from the left menu if not needed this week.',
      special_thanks: 'Special thanks',
      specialThanksTitle: 'Special thanks · slide 25',
      family_joy: 'Family celebration',
      familyJoyTitle: 'Family celebration · slide 26',
      baptism: 'Baptism',
