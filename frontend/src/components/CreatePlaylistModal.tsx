      ...
      <div className="metadata-modal create-playlist-modal" onClick={(e) => e.stopPropagation()}>
        <form onSubmit={(e) => void handleSubmit(e)}>
          <div className="metadata-modal-header">
            <h3 id="create-playlist-modal-title">{t('playlists.importTitle')}</h3>
            <button
              type="button"
          ...
          <div className="metadata-modal-body create-playlist-modal-body">
            <label className="create-playlist-modal-label" htmlFor="create-playlist-modal-input">
              {t('playlists.createPlaceholder')}
            </label>
            <input
              ref={inputRef}
              id="create-playlist-modal-input"
              type="text"
          ...
          <div className="metadata-modal-actions">
            ...
            <button type="submit" className="btn-primary" disabled={disabled || !title.trim()}>
              {submitting || busy ? t('playlists.creating') : t('playlists.importButton')}
            </button>
          </div>
        </form>
      </div>
